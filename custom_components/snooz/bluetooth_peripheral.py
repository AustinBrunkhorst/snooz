from bluepy.btle import (ADDR_TYPE_PUBLIC, ADDR_TYPE_RANDOM, ScanEntry, BTLEDisconnectError, Peripheral)

# patches bluepy peripheral to support timeout during connection
# https://github.com/IanHarvey/bluepy/pull/374
class PeripheralWithConnectTimeout(Peripheral):
